...
class ScenarioGenerator:
    ...
    def _fallback_easy(self) -> dict:
        return {
            ...
            "alerts": [{"id": "ALT-999", "service": "api-server", "severity": "critical", "message": "Health check failed"}],
            "services": [{"name": "api-server", "status": "unhealthy", "calls": []}],
            "dependency_graph": {"api-server": []},
            "logs": [{"timestamp": datetime.now().strftime("%Y-%m-%dT%H:%M:%SZ"), "service": "api-server", "level": "ERROR", "message": "Internal Server Error"}],
            "metrics": [{"service": "api-server", "metric": "error_rate", "values": [1.0], "unit": "ratio", "timestamps": ["00:00"]}],
            "traces": {},
            "root_cause": {
                "service": "api-server",
    ...
    def _easy_db_pool(self) -> dict:
        ...
        return {
            ...
            "alerts": [
                {"id": "ALT-001", "service": "api-gateway", "severity": "critical", "message": "502 error rate > 35%", "time": "14:32:05"},
                {"id": "ALT-002", "service": "user-service", "severity": "warning", "message": "latency p99 > 5s", "time": "14:32:10"},
            ],
            "services": [
            ...
            "dependency_graph": {"api-gateway": ["user-service"], "user-service": ["postgres-primary"], "postgres-primary": []},
            "logs": [
                self._log(base, -3, "postgres-primary", "ERROR", "Connection pool exhausted: max_connections=100 reached"),
                self._log(base, -2, "user-service", "ERROR", "Failed to acquire DB connection"),
            ],
            "metrics": [{"service": "postgres-primary", "metric": "active_connections", "values": [90, 95, 100], "unit": "count", "timestamps": self._ts(base, 3)}],
            "traces": {"req-1": [{"service": "user-service", "duration_ms": 5000, "status": "error"}]},
            "root_cause": {
    ...
    def _easy_oom(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "payment-service", "severity": "critical", "message": "OOMKilled", "time": "09:16:00"}],
            "services": [
                {"name": "checkout-api", "status": "degraded", "calls": ["payment-service"]},
                {"name": "payment-service", "status": "crashing", "calls": []},
            ],
            "dependency_graph": {"checkout-api": ["payment-service"], "payment-service": []},
            "logs": [self._log(base, -1, "payment-service", "CRITICAL", "OOMKilled: memory limit 1024Mi exceeded")],
            "metrics": [{"service": "payment-service", "metric": "memory_usage", "values": [800, 950, 1024, 0], "unit": "MB", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
    ...
    def _easy_disk(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "logging-service", "severity": "critical", "message": "Disk 100% full", "time": "22:00:10"}],
            "services": [{"name": "logging-service", "status": "degraded", "calls": []}],
            "dependency_graph": {"logging-service": []},
            "logs": [self._log(base, 0, "logging-service", "CRITICAL", "No space left on device")],
            "metrics": [{"service": "logging-service", "metric": "disk_usage", "values": [95, 99, 100], "unit": "percent", "timestamps": self._ts(base, 3)}],
            "traces": {},
            "root_cause": {
    ...
    def _easy_redis_crash(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "redis-cache", "severity": "critical", "message": "CrashLoopBackOff", "time": "10:02:00"}],
            "services": [
                {"name": "session-service", "status": "degraded", "calls": ["redis-cache"]},
                {"name": "redis-cache", "status": "unhealthy", "calls": []},
            ],
            "dependency_graph": {"session-service": ["redis-cache"], "redis-cache": []},
            "logs": [self._log(base, 0, "redis-cache", "ERROR", "Failed to load RDB file: unexpected end of file")],
            "metrics": [{"service": "redis-cache", "metric": "up", "values": [1, 1, 0, 0, 1, 0], "unit": "bool", "timestamps": self._ts(base, 6)}],
            "traces": {},
            "root_cause": {
                "service": "redis-cache",
    ...
    def _easy_disk_full_v2(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "storage-node-3", "severity": "critical", "message": "Disk usage critical", "time": "15:05:00"}],
            "services": [{"name": "storage-node-3", "status": "unhealthy", "calls": []}],
            "dependency_graph": {"storage-node-3": []},
            "logs": [self._log(base, 0, "storage-node-3", "ERROR", "IOException: Disk full")],
            "metrics": [{"service": "storage-node-3", "metric": "disk_free", "values": [100, 50, 10, 0], "unit": "MB", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
    ...
    def _easy_port_config(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "auth-service", "severity": "critical", "message": "TargetPort mismatch", "time": "12:01:00"}],
            "services": [
            ...
            "logs": [self._log(base, 0, "api-server", "ERROR", "Connection refused on auth-service:8080")],
            "metrics": [{"service": "auth-service", "metric": "network_errors", "values": [0, 0, 100, 100], "unit": "count", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
    ...
    def _easy_credentials(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "billing-service", "severity": "critical", "message": "DB Access Denied", "time": "08:05:00"}],
            "services": [
                {"name": "billing-service", "status": "unhealthy", "calls": ["billing-db"]},
                {"name": "billing-db", "status": "healthy", "calls": []},
            ],
            "dependency_graph": {"billing-service": ["billing-db"], "billing-db": []},
            "logs": [self._log(base, 0, "billing-service", "ERROR", "FATAL: password authentication failed for user 'billing_app'")],
            "metrics": [{"service": "billing-service", "metric": "db_conn_errors", "values": [0, 1, 5, 20], "unit": "count", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
                "service": "billing-db",
    ...
    def _medium_slow_query(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "search-api", "severity": "warning", "message": "p99 > 8s", "time": "11:03:00"}],
            "services": [
                {"name": "search-api", "status": "degraded", "calls": ["mysql"]},
                {"name": "mysql", "status": "degraded", "calls": []},
            ],
            "dependency_graph": {"search-api": ["mysql"], "mysql": []},
            "logs": [self._log(base, 0, "mysql", "WARN", "Slow query: 12000ms SELECT * FROM items WHERE tags LIKE '%X%'")],
            "metrics": [{"service": "mysql", "metric": "cpu_util", "values": [20, 80, 95], "unit": "percent", "timestamps": self._ts(base, 3)}],
            "traces": {"t-1": [{"service": "mysql", "duration_ms": 12000, "status": "slow"}]},
            "root_cause": {
                "service": "mysql",
    ...
    def _medium_pool_exhaustion(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "order-service", "severity": "critical", "message": "Connection Pool Exhausted", "time": "14:05:00"}],
            "services": [
            ...
            "logs": [self._log(base, 0, "order-service", "ERROR", "HikariPool-1 - Connection is not available, request timed out")],
            "metrics": [{"service": "order-service", "metric": "pool_active", "values": [5, 15, 20, 20], "unit": "count", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
    ...
    def _medium_memory_leak(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "recommendation-engine", "severity": "warning", "message": "Heap usage > 90%", "time": "09:30:00"}],
            "services": [{"name": "recommendation-engine", "status": "degraded", "calls": []}],
            "dependency_graph": {"recommendation-engine": []},
            "logs": [self._log(base, 0, "recommendation-engine", "WARN", "Java heap space low, GC overhead limit exceeded")],
            "metrics": [{"service": "recommendation-engine", "metric": "heap_usage", "values": [200, 400, 600, 800, 950], "unit": "MB", "timestamps": self._ts(base, 5)}],
            "traces": {},
            "root_cause": {
    ...
    def _medium_tls_expiry(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "api-gateway", "severity": "critical", "message": "SSL Handshake Failed", "time": "00:01:00"}],
            "services": [{"name": "api-gateway", "status": "unhealthy", "calls": []}],
            "dependency_graph": {"api-gateway": []},
            "logs": [self._log(base, 0, "api-gateway", "ERROR", "SSL error: certificate_expired")],
            "metrics": [{"service": "api-gateway", "metric": "cert_days_left", "values": [2, 1, 0, 0], "unit": "days", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
                "service": "api-gateway",
    ...
    def _medium_dns_config(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "internal-proxy", "severity": "critical", "message": "UnknownHostException", "time": "16:05:00"}],
            "services": [
                {"name": "internal-proxy", "status": "unhealthy", "calls": ["backend-svc"]},
                {"name": "backend-svc", "status": "healthy", "calls": []},
            ],
            "dependency_graph": {"internal-proxy": ["backend-svc"], "backend-svc": []},
            "logs": [self._log(base, 0, "internal-proxy", "ERROR", "lookup backend-svc.cluster.local on 10.96.0.10:53: no such host")],
            "metrics": [{"service": "internal-proxy", "metric": "dns_errors", "values": [0, 0, 50, 100], "unit": "count", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
    ...
    def _hard_redis_split_brain(self) -> dict:
        ...
        return {
            ...
            "alerts": [
                {"id": "ALT-001", "service": "redis-cluster", "severity": "critical", "message": "split-brain detected", "time": "03:01:45"},
                {"id": "ALT-002", "service": "auth-svc", "severity": "critical", "message": "redis unreachable", "time": "03:02:00"},
            ],
            "services": [
                {"name": "api", "status": "degraded", "calls": ["auth-svc", "session-svc"]},
                {"name": "auth-svc", "status": "unhealthy", "calls": ["redis-cluster"]},
                {"name": "session-svc", "status": "unhealthy", "calls": ["redis-cluster"]},
                {"name": "redis-cluster", "status": "split-brain", "calls": []},
            ],
            "dependency_graph": {"api": ["auth-svc", "session-svc"], "auth-svc": ["redis-cluster"], "session-svc": ["redis-cluster"], "redis-cluster": []},
            "logs": [self._log(base, 0, "redis-cluster", "CRITICAL", "CLUSTER INFO: cluster_state=fail — split-brain")],
            "metrics": [{"service": "redis-cluster", "metric": "nodes_healthy", "values": [6, 6, 3], "unit": "count", "timestamps": self._ts(base, 3)}],
            "traces": {},
            "root_cause": {
    ...
    def _hard_index_corruption(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "report-svc", "severity": "critical", "message": "Data parity check failed", "time": "04:10:00"}],
            "services": [
            ...
            "logs": [self._log(base, 0, "mysql-repl", "ERROR", "Innodb: Found corrupted page [page id: space=123, page number=456]")],
            "metrics": [{"service": "mysql-repl", "metric": "corrupted_pages", "values": [0, 0, 1, 5], "unit": "count", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
                "service": "mysql-repl",
    ...
    def _hard_distributed_split_brain(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "etcd", "severity": "critical", "message": "no leader detected", "time": "02:05:00"}],
            "services": [
            ...
            "logs": [self._log(base, 0, "etcd", "ERROR", "raft.node: 1 [term: 10] ignored a MsgVote from 2 [term: 10] because it already has a leader")],
            "metrics": [{"service": "etcd", "metric": "has_leader", "values": [1, 1, 0, 0], "unit": "bool", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
                "service": "etcd",
                "cause_type": "cluster split-brain 2 nodes network partition",
    ...
    def _hard_config_drift(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "istio-pilot", "severity": "warning", "message": "Push failures low but persistent", "time": "20:15:00"}],
            "services": [
                {"name": "gateway", "status": "degraded", "calls": ["service-a", "service-b", "istio-pilot"]},
                {"name": "istio-pilot", "status": "unhealthy", "calls": []},
                {"name": "service-a", "status": "healthy", "calls": []},
                {"name": "service-b", "status": "healthy", "calls": []},
            ],
            "dependency_graph": {"gateway": ["service-a", "service-b", "istio-pilot"], "istio-pilot": [], "service-a": [], "service-b": []},
            "logs": [self._log(base, 0, "istio-pilot", "WARN", "Config drift detected on proxy node-42: ADS push timeout")],
            "metrics": [{"service": "istio-pilot", "metric": "proxy_sync_errors", "values": [0, 5, 12, 12], "unit": "count", "timestamps": self._ts(base, 4)}],
            "traces": {},
            "root_cause": {
                "service": "istio-pilot",
    ...
    def _hard_rate_limiter(self) -> dict:
        ...
        return {
            ...
            "alerts": [{"id": "ALT-001", "service": "throttle-svc", "severity": "critical", "message": "429 rate > 50%", "time": "11:05:00"}],
            "services": [
            ...
            "logs": [self._log(base, 0, "throttle-svc", "ERROR", "Rate-limiting logic error: bucket negative overflow")],
            "metrics": [{"service": "throttle-svc", "metric": "throttle_rate", "values": [0, 50, 95], "unit": "percent", "timestamps": self._ts(base, 3)}],
            "traces": {},
            "root_cause": {
